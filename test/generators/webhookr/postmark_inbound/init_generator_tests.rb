...
require 'test_helper'
require 'generators/webhookr/postmark_inbound/init_generator'

class InitGeneratorTests < Rails::Generators::TestCase
  tests Webhookr::PostmarkInbound::Generators::InitGenerator
  ...
  test "it should have authorization information" do
    assert_file @initializer do |content|
      assert_match(%r{Webhookr::PostmarkInbound::Adapter\.config\.security_token}, content)
    end
  end
end